...
const eyeColor = {
  ...
  brown: [],
  red: [],
  "blue-gray": [], // il carattere "-" non mi permetterà di usare la dot notation.
};
...
// stampo tutti i generi prima della modifica
for (let i = 0; i < starWarsCharacters.length; i++) {
...
casualIndex = Math.floor(Math.random() * 10);
// let k = 0;
// while(k < 500){
